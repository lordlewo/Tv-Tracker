...
/**
 * Provides the local service interface for Season. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author czeni
 * @see SeasonLocalServiceUtil
...
public interface SeasonLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SeasonLocalServiceUtil} to access the season local service. Add custom service methods to {@link hu.webtown.liferay.tvtracker.service.impl.SeasonLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
