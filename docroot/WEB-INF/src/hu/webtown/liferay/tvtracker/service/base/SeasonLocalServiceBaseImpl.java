...
/**
 * Provides the base implementation for the season local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hu.webtown.liferay.tvtracker.service.impl.SeasonLocalServiceImpl}.
 * </p>
 *
 * @author czeni
 ...
 * @generated
 */
public abstract class SeasonLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SeasonLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link hu.webtown.liferay.tvtracker.service.SeasonLocalServiceUtil} to access the season local service.
	 */
	...
	@Override
	public Season addSeason(Season season) throws SystemException {
		season.setNew(true);

		return seasonPersistence.update(season);
	}
	 ...
	 */
	@Override
	public Season createSeason(long seasonId) {
		return seasonPersistence.create(seasonId);
	}
	...
	public Season deleteSeason(long seasonId)
		...
		return seasonPersistence.remove(seasonId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Season deleteSeason(Season season) throws SystemException {
		return seasonPersistence.remove(season);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Season.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return seasonPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return seasonPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return seasonPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return seasonPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Season fetchSeason(long seasonId) throws SystemException {
		return seasonPersistence.fetchByPrimaryKey(seasonId);
	}
	...
	public Season getSeason(long seasonId)
		throws PortalException, SystemException {
		return seasonPersistence.findByPrimaryKey(seasonId);
	}
	 ...
	 */
	@Override
	public List<Season> getSeasons(int start, int end)
		throws SystemException {
		return seasonPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSeasonsCount() throws SystemException {
		return seasonPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Season updateSeason(Season season) throws SystemException {
		return seasonPersistence.update(season);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("hu.webtown.liferay.tvtracker.model.Season",
			seasonLocalService);
	}
	...
	private SeasonLocalServiceClpInvoker _clpInvoker = new SeasonLocalServiceClpInvoker();
}